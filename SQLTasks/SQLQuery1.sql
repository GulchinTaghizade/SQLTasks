...
SELECT *FROM SATIS
INNER JOIN MEHSUL ON MEHSUL.ID=SATIS.MEHSULID

SELECT COUNT(*) FROM SATIS   --2 


--SELECT SUM(SATISQIYMETI) FROM MEHSUL WHERE datepart(mm,SATISQIYMETI) =month(getdate()) 

--SELECT SUM(SATISQIYMETI)-SUM(ALISQIYMETI) FROM MEHSUL WHERE datepart(mm,SATISQIYMETI) =month(getdate())  
